...
public class ProductCreateViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<Product> _productCreated = new MutableLiveData<>();
    public LiveData<Product> productCreated = _productCreated;

    private final MutableLiveData<String> _errorMessage = new MutableLiveData<>();
    public LiveData<String> errorMessage = _errorMessage;

    // Constructor
    public ProductCreateViewModel(@NonNull Application application) {
        super(application);
        ...
        productRepository.createProduct(productRequestBody, imagePart, new Callback<Product>() {
            ...
            public void onResponse(@NonNull Call<Product> call, @NonNull Response<Product> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    // Thành công
                    _productCreated.setValue(response.body());
                } else {
                    // Thất bại

...
public class ReservationListAdapter extends RecyclerView.Adapter<ReservationListAdapter.ReservationListViewHolder> {
    ...
    static class ReservationListViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView reservationDateTextView;
        ...
        public ReservationListViewHolder(@NonNull View itemView) {
            ...
            reservationDateTextView = itemView.findViewById(R.id.reservation_date_text_view);
        ...
        public void bind(Reservation reservation) {
            ...
            reservationDateTextView.setText(reservation.getReservationTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")));
            reservationTimeTextView.setText(reservation.getReservationTime().format(DateTimeFormatter.ofPattern("HH:mm")));
